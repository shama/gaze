 ...
 */
function defaults(obj, source) { for (var prop in source) { if (obj[prop] == null) { obj[prop] = source[prop]; } } return obj; }
...
function union() { return unique.apply(null, arguments); }
function isString(obj) { return Object.prototype.toString.call(obj) === '[object String]'; }
function isEmpty(obj) { if (obj == null) { return true; } if (Array.isArray(obj) || isString(obj)) { return obj.length === 0; } for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) { return false; } } return true; }
...
Gaze = module.exports.Gaze = __extends(function(patterns, opts, done) {
  var _this = this;
